...
// Variables
const rootDomain = "myxlgroup.me"; // Ganti dengan domain utama kalian
const serviceName = "authentic"; // Ganti dengan nama workers kalian
...
const KV_PROXY_URL = "https://raw.githubusercontent.com/halluboys/xxx/refs/heads/main/kvProxyList.json";
const PROXY_BANK_URL = "https://raw.githubusercontent.com/halluboys/xxx/refs/heads/main/proxyList.txt";
...
<html lang="en" id="html" class="scroll-auto scrollbar-hide dark">
  ...
  <body class="bg-slate-50 dark:bg-slate-900 bg-fixed">
    <div
      ...
      class="fixed z-50 opacity-0 transition-opacity ease-in-out duration-300 mt-9 mr-6 right-0 p-3 max-w-sm bg-white rounded-xl border-2 border-neutral-800 flex items-center gap-x-4 dark:bg-neutral-800 dark:border-white"
    >
      <div class="shrink-0">
        <svg
      ...
      <div>
        ...
        <p class="text-sm text-neutral-800 dark:text-slate-200">
    ...
    <div class="ml-14 flex flex-col items-center min-h-screen">
      <div id="container-info" class="bg-amber-400 border-2 border-neutral-800 text-right px-5 w-full">
        <div class="flex justify-end gap-3 text-sm flex-wrap">
      ...
      <div
        id="container-title"
        class="sticky top-0 bg-white dark:bg-neutral-800 border-b-2 border-neutral-800 dark:border-white z-10 py-6 w-full max-w-7xl px-4"
      >
      ...
      <div class="flex flex-col md:flex-row gap-6 pt-10 w-full max-w-7xl justify-center px-4">
    ...
    <div id="container-window" class="hidden">
      <div class="fixed z-20 top-0 w-full h-full bg-white dark:bg-neutral-800">
        <p
          ...
          class="text-center w-full h-full absolute top-1/4 dark:text-white"
        ></p>
      </div>
      <div
        id="output-window"
        class="fixed z-20 top-0 right-0 w-full h-full flex justify-center items-center hidden"
      >
        <div
          class="w-[90%] md:w-[75%] h-[40%] md:h-[30%] flex flex-col gap-2 p-4 text-center rounded-lg bg-white dark:bg-neutral-900 border-2 border-neutral-800 dark:border-white"
        >
          <div class="flex flex-col gap-2">
            <div class="flex gap-1 justify-between flex-wrap">
              <button
                onclick="copyToClipboardAsTarget('clash')"
                class="flex-1 min-w-[48%] p-2 rounded-full bg-indigo-500 hover:bg-indigo-600 text-white font-semibold transition-colors"
              >
                Clash
              </button>
              <button
          ...
          <button
            ...
            class="w-full p-2 rounded-full bg-indigo-500 hover:bg-indigo-600 text-white font-semibold transition-colors"
          >
            Raw
          </button>
          <button
            onclick="toggleOutputWindow()"
            class="w-full border-2 border-indigo-400 hover:bg-indigo-400 dark:text-white p-2 rounded-full transition-colors"
          >
            Close
          </button>
        </div>
      ...
      >
        <div
          class="w-[90%] md:w-[75%] h-[60%] md:h-[40%] flex flex-col gap-2 p-4 text-center rounded-lg bg-white dark:bg-neutral-900 border-2 border-neutral-800 dark:border-white"
        >
          <div class="flex gap-2">
            <input
              ...
              class="flex-1 px-4 py-2 rounded-md focus:outline-none dark:bg-neutral-800 dark:text-white dark:placeholder-neutral-400"
            />
            <button
              onclick="registerDomain()"
              class="p-2 rounded-full bg-indigo-500 hover:bg-indigo-600 text-white transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
          ...
          <div
            ...
            class="flex-1 w-full rounded-md flex flex-col gap-2 overflow-y-scroll scrollbar-hide p-2 bg-slate-100 dark:bg-neutral-800"
          ></div>
          <button
    ...
    <footer>
      <div class="fixed bottom-3 right-3 flex flex-col gap-2 z-50">
        <a href="${DONATE_LINK}" target="_blank">
          <button
            class="bg-green-500 hover:bg-green-600 transition-colors rounded-full border-2 border-neutral-800 p-2 block text-white dark:border-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
        ...
        <button
          onclick="toggleWildcardsWindow()"
          class="bg-indigo-500 hover:bg-indigo-600 transition-colors rounded-full border-2 border-neutral-800 p-2 text-white PLACEHOLDER_API_READY dark:border-white"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <button
          ...
          class="bg-slate-600 hover:bg-slate-500 transition-colors rounded-full border-2 border-neutral-800 p-2 text-white dark:border-white"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
